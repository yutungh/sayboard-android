...
final class OpenAiClient {
    ...
    static String transcribe(Context context, File audioFile) throws Exception {
        ...
        String boundary = "VoiceKeyboardBoundary" + System.currentTimeMillis();
        ...
        try (OutputStream out = connection.getOutputStream()) {
            ...
            writeFilePart(out, boundary, "file", audioFile, "voice-keyboard.m4a", "audio/mp4");
    ...
    private static String requiredApiKey(Context context) {
        ...
        if (apiKey == null || apiKey.trim().isEmpty()) {
            throw new IllegalStateException("Add your OpenAI API key in Voice Keyboard settings.");
        }
        return apiKey.trim();
    }
